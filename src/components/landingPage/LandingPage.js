...
const LandingPage = () => {
	...
	useEffect(() => {
		const birdNames = ["Northern Cardinal", "Great Horned Owl", "Blue Jay", "Painted Bunting"];
  ...
  return (
	...
	<nav className="nav-container">
  		<Link to="/allBirds" className="toAllBirds-button">
    		Check out our full list of birds
  		</Link>
  		<Link to="/BirdList" className="toBirdList-button">
